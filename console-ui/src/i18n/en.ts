...
export const en = {
  ...
  'theme.filterLabel': 'status filter',
  'theme.filterAll': 'All',
  'theme.filterDurable': 'Durable',
  'theme.filterCaveated': 'Caveated',
  'theme.sortLabel': 'sort claims',
  'theme.sortDefault': 'Default',
  'theme.sortDay': 'Date',
  'theme.filterEmpty': 'No {filter} claims on this theme.',
  'theme.claimDayTip':
    "Day this claim was written into the crystal ledger; if its run carries no date (legacy sweeps), the last pipeline day of its newest cited source.",
  ...
  'knowledge.sortCreated': 'Created',
  'knowledge.themeCreated': 'created {day}',
  'knowledge.themeUpdated': 'updated {day}',
  'knowledge.themeTimesTip':
    "B-axis days from each claim's ledger run (or its newest cited source when the run carries no date): created = the theme's earliest claim day, updated = its latest.",
