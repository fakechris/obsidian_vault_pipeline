...
def build_stage_handlers(pack_name: str = "research-tech") -> list[StageHandlerSpec]:
    return [
        ...
        StageHandlerSpec(
            ...
            description="Deduplicate recently absorbed evergreen objects",
            target_mode="batch",
        ),
        StageHandlerSpec(
        ...
        StageHandlerSpec(
            ...
            runtime_adapter="autopilot_stage",
            stage="quality",
            entrypoint="ovp_pipeline.workflow_handlers:run_autopilot_quality",
        ...
        StageHandlerSpec(
            ...
            runtime_adapter="autopilot_stage",
            stage="absorb",
            entrypoint="ovp_pipeline.workflow_handlers:run_autopilot_absorb",
        ...
        StageHandlerSpec(
            ...
            runtime_adapter="autopilot_stage",
            stage="dedup",
            entrypoint="ovp_pipeline.workflow_handlers:run_autopilot_dedup",
            description="Deduplicate after autopilot absorb",
            target_mode="single_note",
            supports_autopilot=True,
        ),
        StageHandlerSpec(
            ...
            runtime_adapter="autopilot_stage",
            stage="moc",
            entrypoint="ovp_pipeline.workflow_handlers:run_autopilot_moc",
        ...
        StageHandlerSpec(
            ...
            runtime_adapter="autopilot_stage",
            stage="refine",
            entrypoint="ovp_pipeline.workflow_handlers:run_autopilot_refine",
