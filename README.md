...
ovp-next serve --vault-root ~/Documents/ovp-vault                 # web console + API (localhost:3141)
ovp-next mcp --vault-root ~/Documents/ovp-vault                   # MCP stdio server for editors
```
