...
fn render_projection_note(record: &DurableRecord) -> String {
    ...
    note.push('\n');
    note.push_str("> [!warning] Machine-managed file — do not edit\n");
    note.push_str("> This note is auto-generated by `ovp-next project --write`.\n");
    note.push_str("> It will be deleted and rebuilt on `--rebuild`. Write human\n");
    note.push_str("> commentary in a separate note and link here instead.\n\n");
